...
namespace SuperGas.Reports.helpers
{
    public static class Conversores
    {
        public static string NumeroALetras(this decimal numberAsString)
        {
            ...
            {
                string declet = DecimalALetras(decimales);
                //dec = " PESOS CON " + decimales.ToString() + "/100";
                dec = $" QUETZALES Y {declet} CENTAVOS";
            }
        ...
        [SuppressMessage("ReSharper", "CompareOfFloatsByEqualityOperator")]
        private static string DecimalALetras(double value)
        {
            string num2Text; value = Math.Truncate(value);
            if (value == 0) num2Text = "CERO";
            else if (value == 1) num2Text = "UNO";
            ...
            else num2Text = NumeroALetras(Math.Truncate(value / 10) * 10) + " Y " + NumeroALetras(value % 10);
            return num2Text;
