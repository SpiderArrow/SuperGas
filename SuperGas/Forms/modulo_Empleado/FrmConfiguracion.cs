...
namespace SuperGas.Forms.modulo_Empleado
{
    public partial class FrmConfiguracion : Form
    {
        ...
        public FrmEmpleados _frmempleados = null;
        ...
        public FrmConfiguracion(FrmEmpleados frmEmpleados)
        {
            InitializeComponent();
            _frmempleados = frmEmpleados;
        ...
        public void CargarComboConfiguracion()
        {
            List<Configuracion> lista = new List<Configuracion>
            {
                ...
                new Configuracion() { Id = 1, Descripcion = "Roles Empleado" }
            };
        ...
        public void CargarDatos(int opcion) {
            ...
            {
                case 1:
                    CargarDgv(_roles.Listado(null), "Roles Empleado", false, "");
        ...
        public string GuardarEntity() {
            ...
            {
                case 1:
                    return _roles.Insert(new RolEmpleado()
                    {
                        Rol = TxtDescripcion.Text,
                        IsActive = true
                    }); 
                default:
                    return "";
        ...
        public string ActualizarEntity()
        {
            ...
            {
                case 1:
                    return _roles.Update(new RolEmpleado()
                    {
                        Id = _modelo.Id,
                        Rol = TxtDescripcion.Text,
