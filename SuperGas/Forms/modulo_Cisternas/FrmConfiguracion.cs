...
namespace SuperGas.Forms.modulo_Cisternas
{
    public partial class FrmConfiguracion : Form
    {
        ...
        public FrmCisternas _frmcisternas = null;
        ...
        public FrmConfiguracion(FrmCisternas frmCisternas)
        {
            InitializeComponent();
            _frmcisternas = frmCisternas;
        ...
        {
            if (_frmcisternas != null)
            {
                _frmcisternas.CargarTipoCombustible();
            }
            Close();
        }
