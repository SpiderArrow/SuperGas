...
namespace SuperGas.Forms.modulo_Vehiculos
{
    public partial class FrmConfiguracion : Form
    {
        ...
        public FrmCamiones _frmcamiones = null;
        ...
        public FrmConfiguracion(FrmCamiones frmCamiones)
        {
            InitializeComponent();
            _frmcamiones = frmCamiones;
        ...
        {
            if (_frmcamiones != null)
            {
                _frmcamiones.CargarTipoCombustible();
                _frmcamiones.CargarMarcas();
            }
            Close();
        }
        ...
        public void CargarComboConfiguracion()
        {
            List<Configuracion> lista = new List<Configuracion>
            {
                ...
                new Configuracion() { Id = 1, Descripcion = "Tipo Combustible" },
                new Configuracion() { Id = 2, Descripcion = "Marcas" }
            };
        ...
        public void CargarDatos(int opcion) {
            ...
            {
                case 1:
                    CargarDgv(_tipoCombustible.Listado(null), "Tipo Combustible", false, "");
                    MostrarComboPadre(false);
                    break;
                case 2:
                    CargarDgv(_marcas.Listado(null), "Marcas", false, "");
                    MostrarComboPadre(false);
                    break;
                default:
        ...
        public string GuardarEntity() {
            ...
            {
                case 1:
                    return _tipoCombustible.Insert(new TipoCombustible()
                    {
                        Descripcion = TxtDescripcion.Text,
                        IsActive = true
                    }); 
                case 2:
                    return _marcas.Insert(new Marca()
                    {
                        Descripcion = TxtDescripcion.Text,
                        IsActive = true
                    });
        ...
        public string ActualizarEntity()
        {
            ...
            {
                case 1:
                    return _tipoCombustible.Update(new TipoCombustible()
                    {
                        Id = _modelo.Id,
                        Descripcion = TxtDescripcion.Text,
                ...
                case 2:
                    return _marcas.Update(new Marca()
                    {
                        Id = _modelo.Id,
                        Descripcion = TxtDescripcion.Text,
                        IsActive = _modelo.Estado == "Activo"
